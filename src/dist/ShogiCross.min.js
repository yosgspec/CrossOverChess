...
┠${Array(t).fill("──").join("┼")}┨
`),s+this.field.map(t=>r+t.map(t=>t.piece?.toString(a)??t.toString(e)).join(n)+r).join(o)+i+this.stand.toString(e)}async downloadImage(e,a){await oe(this.canvas,e,a)}}export{ee as Board,y as Piece,V as boards,L as canvasFont,j as canvasImage,ae as gameSoft,H as games};