...
`+l,d=`${W.#m(i,90)}
`+d),l+r+a.map((e,a)=>"|"+e.map(e=>W.#l(e.piece)).join("")+"|"+W.#h(a+1)).join(o)+n+`
`+d}}class _{#a;#b;static run(e,a){return new _(e,a)}constructor(e,a){let{name:t,variant:s,url:i,desc:r,playBoard:n,playPieces:o=[],players:l=o.some(({gameName:e},a)=>1<a&&e)?4:2,useStand:d=!1,canvasWidth:S,canvasHeight:p,canvasFit:m="overflow",boardLeft:g=5,boardTop:u=5,panelWidth:h=50,panelHeight:B=0|1.1*h,pieceSize:f=0|.9*h,useRankSize:$=!0,isDrawShadow:y=!0,borderWidth:C=Math.min(h,B)/30,backgroundColor:w="#00000000",autoDrawing:k=!0,moveMode:x="normal",usePlayerControl:N=!0,onDrawed:E,onGameOver:b=(e,a)=>alert(`プレイヤー${a+1}の敗北です。`)}=a;this.name=t,this.variant=s,this.url=i,this.desc=r;let X=O.importAsync(),v=I.importAsync();this.canvas=e;let P=e.getContext("2d");if(P.clearRect(0,0,e.width,e.height),this.ctx=P,this.pieces=A.getPieces(P,{size:f,useRankSize:$,isDrawShadow:y}),!J[n])throw Error(`playBoard=${n}, Unknown board name.`);if(Object.assign(this,J[n]),![2,4].includes(l))throw Error(`players=${l}, players need 2 or 4.`);this.players=l,this.left=g,this.top=u,this.panelWidth=h,this.panelHeight=B,this.borderWidth=C,this.pieceSize=f,this.canvasBackgroundColor=w,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=g+h*(t+1),i=u+B*(a+1);return new Se(P,e,s,i,h,B,t,a,C)})),this.xLen=this.field[0].length,this.yLen=this.field.length,o.forEach(({gameName:e,pieceSet:a},t)=>{if(e)try{this.putStartPieces(t,e,a)}catch(s){console.error(s)}}),this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=g+this.width,this.bottom=u+this.height,this.stand=new K(this),e.width=S??(d?this.stand.right:this.right)+5,e.height=p??this.bottom+5;let{style:M}=e;"overflow"===m?(""===M.maxWidth&&(M.maxWidth="97vw"),""===M.maxHeight&&(M.maxHeight="92vh")):"horizontal"===m?""===M.width&&(M.width="97vw"):"vertical"===m?""===M.height&&(M.height="92vh"):"parentOverflow"===m?(""===M.maxWidth&&(M.maxWidth="100%"),""===M.maxHeight&&(M.maxHeight="100%")):"parentHorizontal"===m?""===M.width&&(M.width="100%"):"parentVertical"===m&&""===M.height&&(M.height="100%"),this.autoDrawing=k,k&&(X.then(()=>this.draw()),v.then(()=>this.draw()),this.draw()),this.onDrawed=E,this.onGameOver=b,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.moveMode=x,this.record=[],this.turn=0,this.#a=ue(this),N&&(this.#b=this.makePlayerControl(),this.#b.add()),this.enPassant=new fe}makePlayerControl(e){return this.#b=new ee(this,e),this.#b}close(){this.#a?.removeEvent(),this.#b?.remove()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#c(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#c(p){let{field:m,xLen:g,yLen:u}=this;if(0===(p=this.degNormal(p)))return;if(![90,180,270].includes(p))throw Error(`deg=${p}, deg need multiple of 90.`);let h=m.map(e=>e.map(({piece:e})=>e));if([90,270].includes(p)){var B;if(g!==u)throw Error(`cols=${g} != rows=${u}, Not rows = cols.`);h=(B=h)[0].map((e,a)=>B.map(e=>e[a]))}[180,270].includes(p)&&h.reverse(),h.forEach(e=>{e.forEach(e=>{e&&(e.deg+=p)}),[90,180].includes(p)&&e.reverse()}),m.forEach((e,a)=>e.forEach((e,t)=>e.piece=h[a][t]))}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.degNormal(e);this.#c(i);let r=Y[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{s[e]&&(this.field[t][a].piece=s[e].clone())})}),this.#c(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:n=!1}=i,{pieces:o}=this,l=this.degNormal(s);"string"==typeof e&&(e=new A(this.ctx,o[e],{displayPtn:r,deg:l,isMoved:n})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=W.convTextPieces(e));let n=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(A.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let o=0;o<i;o++)for(let l=0;l<s;l++)try{let d=n[o][l];a[o][l].piece=A.stringToPiece(t,d)}catch{a[o][l].piece=null}this.stand.clear();let S=n[i];S&&S.forEach(e=>{let a=A.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[n,o]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:n<=(l=this.sidePromo?Math.max(...Object.keys(A.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:o<=l}}#d(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver&&this.onGameOver(this,t)))})}#e(f,$,y,C){let{moveMode:w}=this,{piece:k}=$;if(!k.promo||k.hasAttr("promoted")||k.hasAttr("cantPromotion")||!y){this.addRecord({fromPanel:f,toPanel:$});return}do for(let[x,{name:N}]of Object.entries(k.promo))if(confirm(`成りますか?
${k.char}:${k.name}
　↓
${x}:${N}`)){k.promotion(x),this.addRecord({fromPanel:f,toPanel:$,end:"成"});return}while("free"!==w&&C);this.addRecord({fromPanel:f,toPanel:$,end:"不成"})}movePiece(e,a){let{stand:t,moveMode:s,enPassant:i}=this;if(!e||"viewOnly"===s||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||"free"!==s&&!a.isTarget)return;let{canPromo:r,forcePromo:n}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,a.piece.isMoved=!0,e.piece=null;let o=this.checkCanPromo(a);r||=o.canPromo,n||=o.forcePromo,i.setMoved(a),this.#e(e,a,r,n),this.#d()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:n={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:n.deg,pieceChar:n.char,end:i,fieldText:this.getTextPieces("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved?1:0))},0<r&&a.splice(this.turn+1)}addRecordComment(e,a=0){this.record[this.turn+a].comment=e}#f(E){let{record:b}=this;if(!b[this.turn+E])return;this.turn+=E;let{fieldText:X,fieldMoved:v}=b[this.turn];this.setTextPieces(X),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=!!v[a][t])}))}undoRecord(){this.#f(-1)}redoRecord(){this.#f(1)}moveRecord(e){this.turn=e,this.#f(0)}record2String(e,a,t=!1){let{to:s,from:i,deg:r,pieceChar:n,end:o}=e;if(0===a)return"0: 開始局面";let l=({pX:e})=>(this.xLen-e).toString(t?10:36),d=({pY:e})=>(e+1).toString(t?10:36),S=t?",":"";return`${a}: ${A.degChars[r]}${l(s)}${S}${d(s)}${n}${o}${void 0===i.pX?"":` (${l(i)}${S}${d(i)})`}`}getTextRecord(e=!1){return this.record.slice(0,this.turn+1).map((a,t)=>this.record2String(a,t,e)).join(`
`)}getJsonRecord(e=!0){let a=JSON.stringify(this.record,null,"");return e?encodeURI(a):a}setJsonRecord(e,a){this.record=JSON.parse(decodeURI(e)),this.moveRecord(a??this.record.length-1)}draw(){let{ctx:e,canvas:a,left:t,top:s,width:i,height:r,panelWidth:n,panelHeight:o}=this;0===this.turn&&this.addRecord({inc:0}),e.restore(),e.save(),e.clearRect(0,0,a.width,a.height),e.fillStyle=this.canvasBackgroundColor,e.fillRect(0,0,a.width,a.height),e.fillStyle=this.backgroundColor,e.lineWidth=this.borderWidth,e.strokeStyle=this.borderColor,e.save(),e.translate(t,s),e.fillRect(0,0,i,r),e.strokeRect(0,0,i,r),e.translate(n/2,o/2),e.strokeRect(0,0,i-n,r-o),e.restore(),this.stand.draw(),this.field.forEach(e=>{e.forEach(e=>{e.draw()})}),this.onDrawed&&this.onDrawed(this)}getTextPieces(e="default",a=!1){return"bod"===e?W.getTextPieces(this):this.toString("compact"===e,a)}getRecordComment(e=0){return this.record[this.turn+e]??""}toString(e=!1,a=!1){let{xLen:t}=this,s="",i="",r="",n="",o=`
`;return e||(s=`┏${Array(t).fill("━━").join("┯")}┓
`,i=`
┗${Array(t).fill("━━").join("┷")}┛`,r="┃",n="│",o=`
┠${Array(t).fill("──").join("┼")}┨
`),s+this.field.map(t=>r+t.map(t=>t.piece?.toString(a)??t.toString(e)).join(n)+r).join(o)+i+this.stand.toString(e)}async downloadImage(e,a,t){await le(this.canvas,e??this.name??"shogicross",a,t)}}class ee{static buttonTexts="<>\uD83D\uDD04\uD83D\uDD01\uD83D\uDCF7";#a(){let{canvas:P}=this.board,M=window.getComputedStyle(P);this.component.style.maxWidth=parseFloat(M.width)+"px"}constructor(e,a){this.board=e;let t=new Map([["undoRecord",{title:"一手戻る",text:"&lt;&lt;",onclick:()=>e.undoRecord()}],["redoRecord",{title:"一手進む",text:"&gt;&gt;",onclick:()=>e.redoRecord()}],["rotateLeft",{title:"盤面を左回転",text:"\uD83D\uDD04",onclick:()=>e.rotate(!1)}],["rotateRight",{title:"盤面を右回転",text:"\uD83D\uDD01",onclick:()=>e.rotate()}],["downloadImage",{title:"画像を保存",text:"\uD83D\uDCF7",onclick:()=>e.downloadImage()}]]);a??=[...t.keys(),"textRecord"];let s=Date.now().toString();for(let[i,{onclick:r}]of(this.component=document.createElement("div"),this.component.id=s,this.component.style.display="flex",this.#a(),window.addEventListener("resize",()=>this.#a()),this.component.innerHTML=`${[...t].filter(([e])=>a.includes(e)).map(([e,{title:a,text:t}])=>`<button id="${e}${s}" title="${a}" style="font-family:${O.names};">${t}</button>`).join("")}${a.includes("textRecord")?`<select id="textRecord${s}" style="flex-grow:1; font-family:${O.names};"><option></option></select>`:""}`,t))a.includes(i)&&(this.component.querySelector(`#${i}${s}`).onclick=r);if(!a.includes("textRecord"))return;let n=e.onDrawed??(()=>{});e.onDrawed=async a=>{setTimeout(()=>{let t=this.component.querySelector(`#textRecord${s}`),i=t.querySelector("option"),r=t.cloneNode(!1);a.record.forEach((t,s)=>{let n=i.cloneNode(!1);n.textContent=e.record2String(t,s),s===a.turn&&(n.selected=!0),r.appendChild(n)}),r.onchange=a=>e.moveRecord(a.target.selectedIndex),t.replaceWith(r)}),n(a)}}add(){let{canvas:e}=this.board;e.after(this.component)}remove(){this.component.remove(),window.removeEventListener("resize",()=>this.#a)}}let Be=()=>[...new Set([...ee.buttonTexts+Object.values(G).map(({displayText:e})=>e).join("")+Object.values(H).map(({display:e})=>e?e.join(""):"").join("")])].sort().join("");Object.assign(O,{imported:!1,names:"",async importAsync(){if(this.imported)return;let e=Be(),a=Date.now().toString();return this.names=O.fonts.map(e=>`"${e[0]}${a}"`).join(",")+",serif",Promise.all(O.fonts.map(async([t,s])=>{let i=t.replace(/ /g,"+"),r=`https://fonts.googleapis.com/css2?family=${i}:wght@${s}&text=${e}`,n=await fetch(r);if(!n.ok)return;let o=(await n.text()).match(/url\(.+?\)/g);if(!o)throw Error("Not found font.");for(let l of o){let d=new FontFace(`${t}${a}`,l);document.fonts.add(d),await d.load().catch(()=>{})}})).then(e=>this.imported=!0)}});export{_ as Board,A as Piece,J as boards,O as canvasFont,I as canvasImage,ie as extendData,ae as gameSoft,Y as games,G as panels,U as pieceCost,Z as pieceRange,H as pieces};