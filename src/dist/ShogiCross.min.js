...
`+d}}class _{static run(e,a){return new _(e,a)}constructor(e,a){let{name:t,variant:s,url:i,desc:r,playBoard:o,playPieces:n=[],players:l=n.some(({gameName:e},a)=>1<a&&e)?4:2,useStand:d=!1,canvasWidth:S,canvasHeight:p,canvasFit:m="overflow",boardLeft:g=5,boardTop:h=5,panelWidth:u=50,panelHeight:B=0|1.1*u,pieceSize:f=0|.9*u,useRankSize:$=!0,isDrawShadow:y=!0,borderWidth:C=Math.min(u,B)/30,backgroundColor:w="#00000000",autoDrawing:k=!0,moveMode:x="normal",usePlayerControl:E=!0,onDrawed:N,onGameOver:b=(e,a)=>alert(`プレイヤー${a+1}の敗北です。`)}=a;this.name=t,this.variant=s,this.url=i,this.desc=r;let X=O.importAsync(),v=I.importAsync();this.canvas=e;let P=e.getContext("2d");if(P.clearRect(0,0,e.width,e.height),this.ctx=P,this.pieces=A.getPieces(P,{size:f,useRankSize:$,isDrawShadow:y}),!J[o])throw Error(`playBoard=${o}, Unknown board name.`);if(Object.assign(this,J[o]),![2,4].includes(l))throw Error(`players=${l}, players need 2 or 4.`);this.players=l,this.left=g,this.top=h,this.panelWidth=u,this.panelHeight=B,this.borderWidth=C,this.pieceSize=f,this.canvasBackgroundColor=w,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=g+u*(t+1),i=h+B*(a+1);return new de(P,e,s,i,u,B,t,a,C)})),this.xLen=this.field[0].length,this.yLen=this.field.length,n.forEach(({gameName:e,pieceSet:a},t)=>{if(e)try{this.putStartPieces(t,e,a)}catch(s){console.error(s)}}),this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=g+this.width,this.bottom=h+this.height,this.stand=new Y(this),e.width=S??(d?this.stand.right:this.right)+5,e.height=p??this.bottom+5;let{style:M}=e;"overflow"===m?(""===M.maxWidth&&(M.maxWidth="97vw"),""===M.maxHeight&&(M.maxHeight="92vh")):"horizontal"===m?""===M.width&&(M.width="97vw"):"vertical"===m?""===M.height&&(M.height="92vh"):"parentOverflow"===m?(""===M.maxWidth&&(M.maxWidth="100%"),""===M.maxHeight&&(M.maxHeight="100%")):"parentHorizontal"===m?""===M.width&&(M.width="100%"):"parentVertical"===m&&""===M.height&&(M.height="100%"),this.autoDrawing=k,k&&(X.then(()=>this.draw()),v.then(()=>this.draw()),this.draw()),this.onDrawed=N,this.onGameOver=b,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.moveMode=x,this.record=[],this.turn=0,this.mouseControl=ue(this),E&&(this.playerControl=this.makePlayerControl(),this.playerControl.add()),this.enPassant=new fe}makePlayerControl(e){return this.playerControl=new ee(this,e),this.playerControl}close(){this.mouseControl?.removeEvent(),this.playerControl?.remove()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#a(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#a(p){let{field:m,xLen:g,yLen:h}=this;if(0===(p=this.degNormal(p)))return;if(![90,180,270].includes(p))throw Error(`deg=${p}, deg need multiple of 90.`);let u=m.map(e=>e.map(({piece:e})=>e));if([90,270].includes(p)){var B;if(g!==h)throw Error(`cols=${g} != rows=${h}, Not rows = cols.`);u=(B=u)[0].map((e,a)=>B.map(e=>e[a]))}[180,270].includes(p)&&u.reverse(),u.forEach(e=>{e.forEach(e=>{e&&(e.deg+=p)}),[90,180].includes(p)&&e.reverse()}),m.forEach((e,a)=>e.forEach((e,t)=>e.piece=u[a][t]))}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.degNormal(e);this.#a(i);let r=U[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{s[e]&&(this.field[t][a].piece=s[e].clone())})}),this.#a(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:o=!1}=i,{pieces:n}=this,l=this.degNormal(s);"string"==typeof e&&(e=new A(this.ctx,n[e],{displayPtn:r,deg:l,isMoved:o})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=W.convTextPieces(e));let o=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(A.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let n=0;n<i;n++)for(let l=0;l<s;l++)try{let d=o[n][l];a[n][l].piece=A.stringToPiece(t,d)}catch{a[n][l].piece=null}this.stand.clear();let S=o[i];S&&S.forEach(e=>{let a=A.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[o,n]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:o<=(l=this.sidePromo?Math.max(...Object.keys(A.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:n<=l}}#b(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver&&this.onGameOver(this,t)))})}#c(f,$,y,C){let{moveMode:w}=this,{piece:k}=$;if(!k.promo||k.hasAttr("promoted")||!y){this.addRecord({fromPanel:f,toPanel:$});return}do for(let[x,{name:E}]of Object.entries(k.promo))if(confirm(`成りますか?
${k.char}:${k.name}
　↓
${x}:${E}`)){k.promotion(x),this.addRecord({fromPanel:f,toPanel:$,end:"成"});return}while("free"!==w&&C);this.addRecord({fromPanel:f,toPanel:$,end:"不成"})}movePiece(e,a){let{stand:t,moveMode:s,enPassant:i}=this;if(!e||"viewOnly"===s||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||"free"!==s&&!a.isTarget)return;let{canPromo:r,forcePromo:o}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,a.piece.isMoved=!0,e.piece=null;let n=this.checkCanPromo(a);r||=n.canPromo,o||=n.forcePromo,i.setMoved(a),this.#c(e,a,r,o),this.#b()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:o={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:o.deg,pieceChar:o.char,end:i,fieldText:this.getTextPieces("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved?1:0))},0<r&&a.splice(this.turn+1)}addRecordComment(e,a=0){this.record[this.turn+a].comment=e}#d(N){let{record:b}=this;if(!b[this.turn+N])return;this.turn+=N;let{fieldText:X,fieldMoved:v}=b[this.turn];this.setTextPieces(X),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=!!v[a][t])}))}undoRecord(){this.#d(-1)}redoRecord(){this.#d(1)}moveRecord(e){this.turn=e,this.#d(0)}record2String(e,a,t=!1){let{to:s,from:i,deg:r,pieceChar:o,end:n}=e;if(0===a)return"0: 開始局面";let l=({pX:e})=>(this.xLen-e).toString(t?10:36),d=({pY:e})=>(e+1).toString(t?10:36),S=t?",":"";return`${a}: ${A.degChars[r]}${l(s)}${S}${d(s)}${o}${n}${void 0===i.pX?"":` (${l(i)}${S}${d(i)})`}`}getTextRecord(e=!1){return this.record.slice(0,this.turn+1).map((a,t)=>this.record2String(a,t,e)).join(`
