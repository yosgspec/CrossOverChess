...
`+S}}class H{static #a=[180,90,270,0];constructor(e){this.board=e;let{top:a,right:t,bottom:s,width:i,height:r,panelWidth:n,panelHeight:o,xLen:l,yLen:S}=e;this.clear(),this.left=1.02*t,this.top=a,this.width=i/2,this.height=r,this.right=this.left+this.width,this.bottom=s,this.pitchWidth=n/2,this.pitchHeight=o,this.xLen=l,this.yLen=S}clear(){this.stocks=new Map(H.#a.map(e=>[e,[]]))}releasePiece(e,a={}){if(e.hasAttr("keepOut"))return;let{deg:t,i:s}=a,{board:i}=this,r=this.stocks.get(t);e.piece=r[s],r[s].center=e.center,r[s].middle=e.middle,i.addRecord({toPanel:e,end:"打"}),r.splice(s,1)}add(e){let a=this.stocks.get(e.deg);e.turnFront(),a.push(e),a.sort((e,a)=>Math.sign(e.id-a.id))}capturePiece(e,a,t=!1,s=!1){s||!a||!(t||e.hasAttr("capture"))||a.hasAttr("king")||a.hasAttr("cantCapture")||(a.deg=e.deg,a.isMoved=!0,this.add(a))}draw(){let{board:e,left:a,top:t,width:s,height:i,pitchWidth:r,pitchHeight:n}=this,{ctx:o,xLen:l,yLen:S}=e;o.fillStyle=e.backgroundColor,o.strokeStyle=e.borderColor,o.lineWidth=e.borderWidth,o.save(),o.translate(a,t),o.fillRect(0,0,s,i),o.strokeRect(0,0,s,i),o.restore(),[...this.stocks.values()].forEach((e,s)=>{let i=0;e=e.slice(-S/4*l);for(let o=0|S/4*s;o<S/4*(s+1);o++)for(let d=0;d<l;d++){let m=a+r*(d+1),c=t+n*(o+1),g=e[i++];if(null==g)break;g.center=m,g.middle=c,g.draw()}})}toString(e=!1,a=!1){let{xLen:t}=this.board,s=[...this.stocks.values()].flat().filter(e=>e),i=0<s.length?`
`+"―".repeat(2*t)+`
`:"",r=s.map(e=>e.toString(a)).join("");if(!e)for(let n of(i="",Object.values(y.degChars)))r=r.replace(n,`
${n}持駒：${n}`);return i+r}}let ue=Object.keys(y.degChars),U=()=>({panel:null,piece:null});class he{constructor(){this.degs={},ue.forEach(e=>this.degs[e]=U())}clear(e){this.degs[e]=U()}setTarget(e,a){e.hasTarget("start")&&a.hasAttr("enPassant")&&(this.degs[a.deg].panel=e)}setMoved(e){let{piece:a}=e,t=this.degs[a.deg];a&&e===t.panel?t.piece=a:this.clear(a.deg)}isTarget(e,a){return!e||!e.piece||!!e.piece.hasAttr("enPassant")&&e.piece===this.degs[e.piece.deg].piece}}class _{static run(e,a){let{playBoard:t,playPieces:s,onDrawed:i}=a,r=s.some(({gameName:e},a)=>1<a&&e)?4:2,n=new _(e,t,{...a,players:r,onDrawed:i});return s.forEach(({gameName:e,pieceSet:a},t)=>{if(e){a??="default";try{n.putStartPieces(t,e,a)}catch{}}}),n.onDrawed=i,n}constructor(e,a,t){let{players:s=2,canvasWidth:i,canvasHeight:r,canvasFit:n="overflow",boardLeft:o=5,boardTop:l=5,panelWidth:S=50,panelHeight:d=0|1.1*S,pieceSize:m=0|.9*S,useRankSize:c=!0,isDrawShadow:g=!0,borderWidth:h=Math.min(S,d)/30,useStand:u=!1,backgroundColor:f="#00000000",autoDrawing:W=!0,onDrawed:$,onGameOver:A=e=>alert(`プレイヤー${e+1}の敗北です。`),freeMode:C=!1}=t,w=M.importAsync(),k=j.importAsync();this.canvas=e;let E=e.getContext("2d");if(E.clearRect(0,0,e.width,e.height),this.ctx=E,this.pieces=y.getPieces(E,{size:m,useRankSize:c,isDrawShadow:g}),Object.assign(this,q[a]),![2,4].includes(s))throw Error(`players=${s}, players need 2 or 4.`);this.players=s,this.left=o,this.top=l,this.panelWidth=S,this.panelHeight=d,this.borderWidth=h,this.pieceSize=m,this.canvasBackgroundColor=f,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=o+S*(t+1),i=l+d*(a+1);return new le(E,e,s,i,S,d,h,t,a)})),this.xLen=this.field[0].length,this.yLen=this.field.length,this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=o+this.width,this.bottom=l+this.height,this.stand=new H(this),e.width=i??(u?this.stand.right:this.right)+5,e.height=r??this.bottom+5;let{style:b}=e;"overflow"===n?(""===b.maxWidth&&(b.maxWidth="97vw"),""===b.maxHeight&&(b.maxHeight="97vh")):"horizontal"===n?""===b.width&&(b.width="97vw"):"vertical"===n?""===b.height&&(b.height="97vh"):"parentOverflow"===n?(""===b.maxWidth&&(b.maxWidth="100%"),""===b.maxHeight&&(b.maxHeight="100%")):"parentHorizontal"===n?""===b.width&&(b.width="100%"):"parentVertical"===n&&""===b.height&&(b.height="100%"),this.autoDrawing=W,W&&(w.then(()=>this.draw()),k.then(()=>this.draw()),this.draw()),this.onDrawed=$,this.onGameOver=A,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.#a(e),!0])),this.freeMode=C,this.record=[],this.turn=0,this.uiControl=ge(this),this.enPassant=new he}close(){this.uiControl.removeEvent()}#a(m){let c=m;0<c&&c<4&&(c=0|360*c/this.players);do c=(c+360)%360;while(c<0);return c}rotateField(e){let{xLen:a,yLen:t}=this;if(0!==(e=this.#a(e))){if(![90,180,270].includes(e))throw Error(`deg=${e}, deg need multiple of 90.`);if([90,270].includes(e)){var s;if(a!==t)throw Error(`cols=${a} != rows=${t}, Not rows = cols.`);this.field=(s=this.field)[0].map((e,a)=>s.map(e=>e[a]))}[180,270].includes(e)&&this.field.reverse(),this.field.forEach(a=>{a.forEach(a=>{a.piece&&(a.piece.deg+=e)}),[90,180].includes(e)&&a.reverse()})}}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.#a(e);this.rotateField(i);let r=z[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{if(!s[e])return;let i=s[e].clone(),r=this.field[t][a];i.center=r.center,i.middle=r.middle,r.piece=i})}),this.rotateField(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:n=!1}=i,{pieces:o}=this,l=this.#a(s);"string"==typeof e&&(e=new y(this.ctx,o[e],{displayPtn:r,deg:l,isMoved:n}));let S=this.field[t][a];e.center=S.center,e.middle=S.middle,S.piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=B.convSetText(e));let n=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(y.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let o=0;o<i;o++)for(let l=0;l<s;l++)try{let S=n[o][l],d=y.stringToPiece(t,S);d.center=a[o][l].center,d.middle=a[o][l].middle,a[o][l].piece=d}catch{a[o][l].piece=null}this.stand.clear();let m=n[i];m&&m.forEach(e=>{let a=y.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.#a(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.#a(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[n,o]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:n<=(l=this.sidePromo?Math.max(...Object.keys(y.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:o<=l}}#b(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver(t)))})}#c(g,h,u,f){let{freeMode:W}=this,{piece:$}=h;if(!$.promo||$.hasAttr("promoted")||!u){this.addRecord({fromPanel:g,toPanel:h});return}do for(let[A,{name:C}]of Object.entries($.promo))if(confirm(`成りますか?
${$.char}:${$.name}
　↓
${A}:${C}`)){this.addRecord({fromPanel:g,toPanel:h,end:"成"}),$.promotion(A);return}while(!W&&f);this.addRecord({fromPanel:g,toPanel:h,end:"不成"})}movePiece(e,a){let{stand:t,freeMode:s,enPassant:i}=this;if(!e||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||!s&&!a.isTarget)return;let{canPromo:r,forcePromo:n}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,e.piece=null;let{piece:o}=a;o.center=a.center,o.middle=a.middle,o.isMoved=!0;let l=this.checkCanPromo(a);r||=l.canPromo,n||=l.forcePromo,i.setMoved(a),this.#c(e,a,r,n),this.#b()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:n={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:n.deg,pieceChar:n.char,end:i,fieldText:this.getText("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved))},0<r&&a.splice(this.turn+1)}#d(w){let{record:k}=this;if(!k[this.turn+w])return;this.turn+=w;let{fieldText:E,fieldMoved:b}=k[this.turn];this.setTextPieces(E),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=b[a][t])}))}undoRecord(){this.#d(-1)}redoRecord(){this.#d(1)}getTextRecord(){let e=({pX:e})=>null==e?"*":(this.xLen-e).toString(36),a=({pY:e})=>null==e?"*":(e+1).toString(36);return this.record.slice(1,this.turn+1).map(({to:t,from:s,deg:i,pieceChar:r,end:n},o)=>`${o}: ${y.degChars[i]}${e(t)}${a(t)}${r}${n} (${e(s)}${a(s)})`).join(`
