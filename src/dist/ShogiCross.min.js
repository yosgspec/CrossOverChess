...
`+d}}class ee{static run(e,a){return new ee(e,a)}constructor(e,a){let{name:t,variant:s,url:i,desc:r,playBoard:o,playPieces:n=[],players:l=n.some(({gameName:e},a)=>1<a&&e)?4:2,useStand:d=!1,canvasWidth:S,canvasHeight:m,canvasFit:c="overflow",boardLeft:g=5,boardTop:h=5,panelWidth:u=50,panelHeight:B=0|1.1*u,pieceSize:f=0|.9*u,useRankSize:$=!0,isDrawShadow:y=!0,borderWidth:C=Math.min(u,B)/30,backgroundColor:w="#00000000",autoDrawing:k=!0,moveMode:x="normal",usePlayerControl:E=!0,onDrawed:N,onGameOver:b=(e,a)=>alert(`プレイヤー${a+1}の敗北です。`)}=a;this.name=t,this.variant=s,this.url=i,this.desc=r;let X=O.importAsync(),v=z.importAsync();this.canvas=e;let P=e.getContext("2d");if(P.clearRect(0,0,e.width,e.height),this.ctx=P,this.pieces=A.getPieces(P,{size:f,useRankSize:$,isDrawShadow:y}),!U[o])throw Error(`playBoard=${o}, Unknown board name.`);if(Object.assign(this,U[o]),![2,4].includes(l))throw Error(`players=${l}, players need 2 or 4.`);this.players=l,this.left=g,this.top=h,this.panelWidth=u,this.panelHeight=B,this.borderWidth=C,this.pieceSize=f,this.canvasBackgroundColor=w,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=g+u*(t+1),i=h+B*(a+1);return new le(P,e,s,i,u,B,t,a,C)})),this.xLen=this.field[0].length,this.yLen=this.field.length,n.forEach(({gameName:e,pieceSet:a},t)=>{if(e)try{this.putStartPieces(t,e,a)}catch(s){console.error(s)}}),this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=g+this.width,this.bottom=h+this.height,this.stand=new K(this),e.width=S??(d?this.stand.right:this.right)+5,e.height=m??this.bottom+5;let{style:M}=e;"overflow"===c?(""===M.maxWidth&&(M.maxWidth="97vw"),""===M.maxHeight&&(M.maxHeight="92vh")):"horizontal"===c?""===M.width&&(M.width="97vw"):"vertical"===c?""===M.height&&(M.height="92vh"):"parentOverflow"===c?(""===M.maxWidth&&(M.maxWidth="100%"),""===M.maxHeight&&(M.maxHeight="100%")):"parentHorizontal"===c?""===M.width&&(M.width="100%"):"parentVertical"===c&&""===M.height&&(M.height="100%"),this.autoDrawing=k,k&&(X.then(()=>this.draw()),v.then(()=>this.draw()),this.draw()),this.onDrawed=N,this.onGameOver=b,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.moveMode=x,this.record=[],this.turn=0,this.mouseControl=ge(this),E&&(this.playerControl=this.makePlayerControl(),this.playerControl.add()),this.enPassant=new he}makePlayerControl(e){return this.playerControl=new te(this,e),this.playerControl}close(){this.mouseControl?.removeEvent(),this.playerControl?.remove()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#a(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#a(m){let{field:c,xLen:g,yLen:h}=this;if(0===(m=this.degNormal(m)))return;if(![90,180,270].includes(m))throw Error(`deg=${m}, deg need multiple of 90.`);let u=c.map(e=>e.map(({piece:e})=>e));if([90,270].includes(m)){var B;if(g!==h)throw Error(`cols=${g} != rows=${h}, Not rows = cols.`);u=(B=u)[0].map((e,a)=>B.map(e=>e[a]))}[180,270].includes(m)&&u.reverse(),u.forEach(e=>{e.forEach(e=>{e&&(e.deg+=m)}),[90,180].includes(m)&&e.reverse()}),c.forEach((e,a)=>e.forEach((e,t)=>e.piece=u[a][t]))}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.degNormal(e);this.#a(i);let r=Y[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{s[e]&&(this.field[t][a].piece=s[e].clone())})}),this.#a(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:o=!1}=i,{pieces:n}=this,l=this.degNormal(s);"string"==typeof e&&(e=new A(this.ctx,n[e],{displayPtn:r,deg:l,isMoved:o})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=W.convTextPieces(e));let o=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(A.degChars).map(e=>`
