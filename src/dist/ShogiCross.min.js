...
${n}持駒：${n}`);return i+r}}let ue=Object.keys(y.degChars),q=()=>({panel:null,piece:null});class he{constructor(){this.degs={},ue.forEach(e=>this.degs[e]=q())}clear(e){this.degs[e]=q()}setTarget(e,a){e.hasTarget("start")&&a.hasAttr("enPassant")&&(this.degs[a.deg].panel=e)}setMoved(e){let{piece:a}=e,t=this.degs[a.deg];a&&e===t.panel?t.piece=a:this.clear(a.deg)}isTarget(e,a){return!e||!e.piece||!!e.piece.hasAttr("enPassant")&&e.piece===this.degs[e.piece.deg].piece}}class ee{static run(e,a){return new ee(e,a)}constructor(e,a){let{playBoard:t,playPieces:s=[],players:i=s.some(({gameName:e},a)=>1<a&&e)?4:2,canvasWidth:r,canvasHeight:n,canvasFit:o="overflow",boardLeft:l=5,boardTop:S=5,panelWidth:d=50,panelHeight:m=0|1.1*d,pieceSize:g=0|.9*d,useRankSize:c=!0,isDrawShadow:h=!0,borderWidth:u=Math.min(d,m)/30,useStand:B=!1,backgroundColor:W="#00000000",autoDrawing:$=!0,onDrawed:A,onGameOver:C=e=>alert(`プレイヤー${e+1}の敗北です。`),freeMode:w=!1}=a,k=M.importAsync(),N=j.importAsync();this.canvas=e;let E=e.getContext("2d");if(E.clearRect(0,0,e.width,e.height),this.ctx=E,this.pieces=y.getPieces(E,{size:g,useRankSize:c,isDrawShadow:h}),s.forEach(({gameName:e,pieceSet:a="default"},t)=>{if(e)try{board.putStartPieces(t,e,a)}catch{}}),Object.assign(this,V[t]),![2,4].includes(i))throw Error(`players=${i}, players need 2 or 4.`);this.players=i,this.left=l,this.top=S,this.panelWidth=d,this.panelHeight=m,this.borderWidth=u,this.pieceSize=g,this.canvasBackgroundColor=W,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=l+d*(t+1),i=S+m*(a+1);return new le(E,e,s,i,d,m,t,a,u)})),this.xLen=this.field[0].length,this.yLen=this.field.length,this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=l+this.width,this.bottom=S+this.height,this.stand=new J(this),e.width=r??(B?this.stand.right:this.right)+5,e.height=n??this.bottom+5;let{style:b}=e;"overflow"===o?(""===b.maxWidth&&(b.maxWidth="97vw"),""===b.maxHeight&&(b.maxHeight="97vh")):"horizontal"===o?""===b.width&&(b.width="97vw"):"vertical"===o?""===b.height&&(b.height="97vh"):"parentOverflow"===o?(""===b.maxWidth&&(b.maxWidth="100%"),""===b.maxHeight&&(b.maxHeight="100%")):"parentHorizontal"===o?""===b.width&&(b.width="100%"):"parentVertical"===o&&""===b.height&&(b.height="100%"),this.autoDrawing=$,$&&(k.then(()=>this.draw()),N.then(()=>this.draw()),this.draw()),this.onDrawed=A,this.onGameOver=C,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.freeMode=w,this.record=[],this.turn=0,this.uiControl=ge(this),this.enPassant=new he}close(){this.uiControl.removeEvent()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#a(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#a(m){let{field:g,xLen:c,yLen:h}=this;if(0===(m=this.degNormal(m)))return;if(![90,180,270].includes(m))throw Error(`deg=${m}, deg need multiple of 90.`);let u=g.map(e=>e.map(({piece:e})=>e));if([90,270].includes(m)){var B;if(c!==h)throw Error(`cols=${c} != rows=${h}, Not rows = cols.`);u=(B=u)[0].map((e,a)=>B.map(e=>e[a]))}[180,270].includes(m)&&u.reverse(),u.forEach(e=>{e.forEach(e=>{e&&(e.deg+=m)}),[90,180].includes(m)&&e.reverse()}),g.forEach((e,a)=>e.forEach((e,t)=>e.piece=u[a][t]))}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.degNormal(e);this.#a(i);let r=H[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{s[e]&&(this.field[t][a].piece=s[e].clone())})}),this.#a(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:n=!1}=i,{pieces:o}=this,l=this.degNormal(s);"string"==typeof e&&(e=new y(this.ctx,o[e],{displayPtn:r,deg:l,isMoved:n})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=f.convSetText(e));let n=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(y.degChars).map(e=>`
