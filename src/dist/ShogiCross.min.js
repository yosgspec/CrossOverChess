...
${i}`}static getText(e){let{field:a,xLen:t,players:s,stand:i}=e,r=` ${[...Array(t).keys()].map(e=>` ${W.#j(t-e)}`).join("")}
+${Array(t).fill("---").join("")}+
`,n=`
+${Array(t).fill("---").join("")}+`,o=`
`,l=`${W.#m(i,180)}
