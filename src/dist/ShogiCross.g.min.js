...
┠${Array(a).fill("──").join("┼")}┨
`),t+this.field.map(a=>i+a.map(a=>""+(a.piece??a.toString(e))).join(r)+i).join(n)+s+this.stand.toString(e)}async downloadImage(e,a){await u(this.canvas,e,a)}}return e.Board=j,e.Piece=B,e.boards=i,e.canvasFont=a,e.canvasImage=g,e.gameSoft=t,e.games=s,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),e}({});