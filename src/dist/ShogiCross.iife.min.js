...
`+S}}class O{static #a=[180,90,270,0];constructor(e){this.board=e;let{top:a,right:t,bottom:s,width:i,height:r,panelWidth:n,panelHeight:o,xLen:l,yLen:S}=e;this.clear(),this.left=1.02*t,this.top=a,this.width=i/2,this.height=r,this.right=this.left+this.width,this.bottom=s,this.pitchWidth=n/2,this.pitchHeight=o,this.xLen=l,this.yLen=S}clear(){this.stocks=new Map(O.#a.map(e=>[e,[]]))}releasePiece(e,a={}){if(e.hasAttr("keepOut"))return;let{deg:t,i:s}=a,{board:i}=this,r=this.stocks.get(t);e.piece=r[s],r[s].center=e.center,r[s].middle=e.middle,i.addRecord({toPanel:e,end:"打"}),r.splice(s,1)}add(e){let a=this.stocks.get(e.deg);e.turnFront(),a.push(e),a.sort((e,a)=>Math.sign(e.id-a.id))}capturePiece(e,a,t=!1,s=!1){s||!a||!(t||e.hasAttr("capture"))||a.hasAttr("king")||a.hasAttr("cantCapture")||(a.deg=e.deg,a.isMoved=!0,this.add(a))}rotate(e){[...this.stocks].forEach(([a,t])=>{let s=this.board.degNormal(a+e);t.forEach(e=>e.deg=s),this.stocks.set(s,t)})}draw(){let{board:e,left:a,top:t,width:s,height:i,pitchWidth:r,pitchHeight:n}=this,{ctx:o,xLen:l,yLen:S}=e;o.fillStyle=e.backgroundColor,o.strokeStyle=e.borderColor,o.lineWidth=e.borderWidth,o.save(),o.translate(a,t),o.fillRect(0,0,s,i),o.strokeRect(0,0,s,i),o.restore(),[...this.stocks.values()].forEach((e,s)=>{let i=0;e=e.slice(-S/4*l);for(let o=0|S/4*s;o<S/4*(s+1);o++)for(let d=0;d<l;d++){let p=a+r*(d+1),m=t+n*(o+1),g=e[i++];if(null==g)break;g.center=p,g.middle=m,g.draw()}})}toString(e=!1,a=!1){let{xLen:t}=this.board,s=[...this.stocks.values()].flat().filter(e=>e),i=0<s.length?`
`+"―".repeat(2*t)+`
`:"",r=s.map(e=>e.toString(a)).join("");if(!e)for(let n of(i="",Object.values(B.degChars)))r=r.replace(n,`
${n}持駒：${n}`);return i+r}}let F=Object.keys(B.degChars),R=()=>({panel:null,piece:null});class j{static run(e,a){let{playBoard:t,playPieces:s,onDrawed:i}=a,r=s.some(({gameName:e},a)=>1<a&&e)?4:2,n=new j(e,t,{...a,players:r,onDrawed:i});return s.forEach(({gameName:e,pieceSet:a},t)=>{if(e){a??="default";try{n.putStartPieces(t,e,a)}catch{}}}),n.onDrawed=i,n}constructor(e,t,s){let{players:r=2,canvasWidth:n,canvasHeight:o,canvasFit:l="overflow",boardLeft:S=5,boardTop:d=5,panelWidth:p=50,panelHeight:m=0|1.1*p,pieceSize:c=0|.9*p,useRankSize:h=!0,isDrawShadow:W=!0,borderWidth:y=Math.min(p,m)/30,useStand:w=!1,backgroundColor:k="#00000000",autoDrawing:_=!0,onDrawed:N,onGameOver:E=e=>alert(`プレイヤー${e+1}の敗北です。`),freeMode:b=!1}=s,x=a.importAsync(),X=g.importAsync();this.canvas=e;let P=e.getContext("2d");if(P.clearRect(0,0,e.width,e.height),this.ctx=P,this.pieces=B.getPieces(P,{size:c,useRankSize:h,isDrawShadow:W}),Object.assign(this,i[t]),![2,4].includes(r))throw Error(`players=${r}, players need 2 or 4.`);this.players=r,this.left=S,this.top=d,this.panelWidth=p,this.panelHeight=m,this.borderWidth=y,this.pieceSize=c,this.canvasBackgroundColor=k,this.field=this.field.map((e,a)=>[...e].map((e,t)=>new u(P,e,S+p*(t+1),d+m*(a+1),p,m,t,a,y))),this.xLen=this.field[0].length,this.yLen=this.field.length,this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=S+this.width,this.bottom=d+this.height,this.stand=new O(this),e.width=n??(w?this.stand.right:this.right)+5,e.height=o??this.bottom+5;let{style:v}=e;"overflow"===l?(""===v.maxWidth&&(v.maxWidth="97vw"),""===v.maxHeight&&(v.maxHeight="97vh")):"horizontal"===l?""===v.width&&(v.width="97vw"):"vertical"===l?""===v.height&&(v.height="97vh"):"parentOverflow"===l?(""===v.maxWidth&&(v.maxWidth="100%"),""===v.maxHeight&&(v.maxHeight="100%")):"parentHorizontal"===l?""===v.width&&(v.width="100%"):"parentVertical"===l&&""===v.height&&(v.height="100%"),this.autoDrawing=_,_&&(x.then(()=>this.draw()),X.then(()=>this.draw()),this.draw()),this.onDrawed=N,this.onGameOver=E,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.freeMode=b,this.record=[],this.turn=0,this.uiControl=function e(a){let t=!1,s=[],i=null,r=null,{canvas:n}=a,o=(e,t,i=()=>{})=>{let r=window.getComputedStyle(n),o=e.target.getBoundingClientRect(),l=n.width/parseFloat(r.width),S=n.height/parseFloat(r.height);if(e.clientX)l*=e.clientX-o.left,S*=e.clientY-o.top;else if(0<e.touches.length){if(1<e.touches.length)return;l*=e.touches[0].clientX-o.left,S*=e.touches[0].clientY-o.top}else e.preventDefault(),[l,S]=s;a.field.forEach((e,a)=>e.forEach((e,s)=>t(e,l,S,s,a))),i(l,S),a.draw(),s=[l,S]},l=e=>{t=!0,o(e,(t,s,r)=>{let{piece:n,pX:o,pY:l}=t;n&&t.checkRangeMouse(s,r)&&(e.preventDefault(),n.isSelected=!0,i=t,function e(a,t,s,i){let{field:r,yLen:n,enPassant:o}=a;function l(e,a){return r[a]&&r[a][e]&&!r[a][e].hasAttr("keepOut")}function S(e){return e.piece&&t.hasAttr("po")&&e.piece.hasAttr("po")}function d(e,l,d,p="",m=!0){var g;if(!r[d]||!r[d][l])return!1;let c=r[d][l];return!(!c||S(c)||(g=c).piece&&!t.isMoved&&!g.piece.isMoved&&t.hasAttr("pao")&&t.cost<g.piece.cost||"enPassant"===p&&!o.isTarget(c,t)||t.hasAttr("inPalace")&&!c.hasAttr("palace")||0===p.indexOf("palace")&&!(c.hasAttr(p)&&r[i][s].hasAttr(p))||t.hasAttr("unCrossRiver")&&n-(0|n/2)<=a.getRow(l,d,t.deg))&&(e?!!r[d][l].piece&&(!m||t.deg!==r[d][l].piece.deg):!r[d][l].piece)}function p(e,a,t,r,n){for(let o of a)for(let S=0;S<e.length;S++)for(let p=0;p<e[S].length;p++){let[m,g]=[p+s-r,S+i-n];if(!(!l(m,g)||d(t,0|m,0|g,"",!1)||e[S][p]!==o))return!0}return!1}function m(e,a,s){let i=r[s][a];i.addTarget(e),o.setTarget(i,t)}function g(e,[a,{isAttack:t}],{oX:r,oY:n,isOwn:o}){if(o)for(let[S,{child:g=[]}={}]of $)for(let c=0;c<e.length;c++)for(let h=0;h<e[c].length;h++){let[u,B]=[h+s-r,c+i-n];!l(u,B)||!d(t,u,B,a)||e[c][h]!==S||p(e,g,!1,r,n)||m(a,u,B)}}function c(e,[a,{isAttack:t}],{oX:n,oY:o,isOwn:p,offsetX:g,offsetY:c}){if(!(!p&&!d(!1,s+g,i+c)))for(let[h,{jmps:u=0,moves:B=0}={}]of A){let f=!B||0===B;for(let W=o-1;W<=o+1;W++)for(let $=n-1;$<=n+1;$++){if(e[W][$]!==h||$===n&&W===o)continue;let y=u||0,C=B||0,[w,k]=[$-n,W-o];for(let _=s,N=i;;){_+=w,N+=k;let E=_+g,b=N+c;if(!l(E,b)||!f&&0===C)break;let x=0===y;x&&d(t,E,b,a,x)?(C--,m(a,E,b)):u<1&&C--;let X=r[b][E];if(X.piece&&(y--,x||S(X)))break}}}}!function(){let e=t.getRange();for(let a of(e.attack??=e.default,f)){let s=a[0];if(t.isMoved&&["start","castling"].includes(s))continue;let i=e[s];if(i)for(let r of C(i))g(i,a,r),c(i,a,r)}}()}(a,n,o,l))},(t,s)=>{for(let[i,n]of a.stand.stocks)for(let o=n.length-1;0<=o;o--)if(n[o].checkRangeMouse(t,s)){e.preventDefault(),n[o].isSelected=!0,r={deg:i,i:o};return}})},S=e=>{t&&(i||r)&&o(e,(e,a,t)=>{e.isSelected=e.checkRangeMouse(a,t)})},d=e=>{t=!1,o(e,(e,t,s)=>{e.checkRangeMouse(t,s)&&(i&&a.movePiece(i,e),r&&!e.piece&&a.stand.releasePiece(e,r))}),o(e,e=>{e.piece&&(e.piece.isSelected=!1),e.isSelected=!1,e.clearTarget()},()=>{for(let[e,t]of a.stand.stocks)for(let s=t.length-1;0<=s;s--)t[s].isSelected=!1;i=null,r=null})};return n.addEventListener("mousedown",l),n.addEventListener("mousemove",S),n.addEventListener("mouseup",d),n.addEventListener("touchstart",l),n.addEventListener("touchmove",S),n.addEventListener("touchend",d),{removeEvent(){n.removeEventListener("mousedown",l),n.removeEventListener("mousemove",S),n.removeEventListener("mouseup",d),n.removeEventListener("touchstart",l),n.removeEventListener("touchmove",S),n.removeEventListener("touchend",d)}}}(this),this.enPassant=new class e{constructor(){this.degs={},F.forEach(e=>this.degs[e]=R())}clear(e){this.degs[e]=R()}setTarget(e,a){e.hasTarget("start")&&a.hasAttr("enPassant")&&(this.degs[a.deg].panel=e)}setMoved(e){let{piece:a}=e,t=this.degs[a.deg];a&&e===t.panel?t.piece=a:this.clear(a.deg)}isTarget(e,a){return!e||!e.piece||!!e.piece.hasAttr("enPassant")&&e.piece===this.degs[e.piece.deg].piece}}}close(){this.uiControl.removeEvent()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#a(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#a(D){let{field:T,xLen:z,yLen:G}=this;if(0===(D=this.degNormal(D)))return;if(![90,180,270].includes(D))throw Error(`deg=${D}, deg need multiple of 90.`);let I=T.map(e=>e.map(({piece:e})=>e));if([90,270].includes(D)){var H;if(z!==G)throw Error(`cols=${z} != rows=${G}, Not rows = cols.`);I=(H=I)[0].map((e,a)=>H.map(e=>e[a]))}[180,270].includes(D)&&I.reverse(),I.forEach(e=>{e.forEach(e=>{e&&(e.deg+=D)}),[90,180].includes(D)&&e.reverse()}),T.forEach((e,a)=>e.forEach((e,t)=>e.piece=I[a][t]))}putStartPieces(e,a,t="default"){let{pieces:i}=this,r=this.degNormal(e);this.#a(r);let n=s[a].position[this.xLen][t];if(!n)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);n.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-n.length;[...e].forEach((e,a)=>{i[e]&&(this.field[t][a].piece=i[e].clone())})}),this.#a(-r),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:n=!1}=i,{pieces:o}=this,l=this.degNormal(s);"string"==typeof e&&(e=new B(this.ctx,o[e],{displayPtn:r,deg:l,isMoved:n})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=w.convSetText(e));let n=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(B.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let o=0;o<i;o++)for(let l=0;l<s;l++)try{let S=n[o][l];a[o][l].piece=B.stringToPiece(t,S)}catch{a[o][l].piece=null}this.stand.clear();let d=n[i];d&&d.forEach(e=>{let a=B.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[n,o]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:n<=(l=this.sidePromo?Math.max(...Object.keys(B.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:o<=l}}#b(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver(t)))})}#c(Y,K,U,J){let{freeMode:q}=this,{piece:V}=K;if(!V.promo||V.hasAttr("promoted")||!U){this.addRecord({fromPanel:Y,toPanel:K});return}do for(let[Q,{name:Z}]of Object.entries(V.promo))if(confirm(`成りますか?
${V.char}:${V.name}
　↓
${Q}:${Z}`)){this.addRecord({fromPanel:Y,toPanel:K,end:"成"}),V.promotion(Q);return}while(!q&&J);this.addRecord({fromPanel:Y,toPanel:K,end:"不成"})}movePiece(e,a){let{stand:t,freeMode:s,enPassant:i}=this;if(!e||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||!s&&!a.isTarget)return;let{canPromo:r,forcePromo:n}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,a.piece.isMoved=!0,e.piece=null;let o=this.checkCanPromo(a);r||=o.canPromo,n||=o.forcePromo,i.setMoved(a),this.#c(e,a,r,n),this.#b()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:n={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:n.deg,pieceChar:n.char,end:i,fieldText:this.getText("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved))},0<r&&a.splice(this.turn+1)}#d(ee){let{record:ea}=this;if(!ea[this.turn+ee])return;this.turn+=ee;let{fieldText:et,fieldMoved:es}=ea[this.turn];this.setTextPieces(et),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=es[a][t])}))}undoRecord(){this.#d(-1)}redoRecord(){this.#d(1)}getTextRecord(){let e=({pX:e})=>null==e?"*":(this.xLen-e).toString(36),a=({pY:e})=>null==e?"*":(e+1).toString(36);return this.record.slice(1,this.turn+1).map(({to:t,from:s,deg:i,pieceChar:r,end:n},o)=>`${o}: ${B.degChars[i]}${e(t)}${a(t)}${r}${n} (${e(s)}${a(s)})`).join(`
...
┠${Array(t).fill("──").join("┼")}┨
`),s+this.field.map(t=>r+t.map(t=>t.piece?.toString(a)??t.toString(e)).join(n)+r).join(o)+i+this.stand.toString(e)}async downloadImage(e,a){await h(this.canvas,e,a)}}return e.Board=j,e.Piece=B,e.boards=i,e.canvasFont=a,e.canvasImage=g,e.gameSoft=t,e.games=s,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),e}({});