...
`+l,d=`${k.#m(i,90)}
`+d),l+r+a.map((e,a)=>"|"+e.map(e=>k.#l(e.piece)).join("")+"|"+k.#h(a+1)).join(n)+o+`
`+d}}class F{#a;#b;static run(e,a){return new F(e,a)}constructor(e,t){let{name:s,variant:r,url:o,desc:n,playBoard:l,playPieces:d=[],players:S=d.some(({gameName:e},a)=>1<a&&e)?4:2,useStand:m=!1,canvasWidth:c,canvasHeight:B,canvasFit:$="overflow",boardLeft:k=5,boardTop:_=5,panelWidth:x=50,panelHeight:b=0|1.1*x,pieceSize:E=0|.9*x,useRankSize:N=!0,isDrawShadow:X=!0,borderWidth:v=Math.min(x,b)/30,backgroundColor:P="#00000000",autoDrawing:L=!0,moveMode:O="normal",usePlayerControl:M=!0,onDrawed:F,onGameOver:R=(e,a)=>alert(`プレイヤー${a+1}の敗北です。`)}=t;this.name=s,this.variant=r,this.url=o,this.desc=n;let j=a.importAsync(),D=p.importAsync();this.canvas=e;let T=e.getContext("2d");if(T.clearRect(0,0,e.width,e.height),this.ctx=T,this.pieces=g.getPieces(T,{size:E,useRankSize:N,isDrawShadow:X}),!i[l])throw Error(`playBoard=${l}, Unknown board name.`);if(Object.assign(this,i[l]),![2,4].includes(S))throw Error(`players=${S}, players need 2 or 4.`);this.players=S,this.left=k,this.top=_,this.panelWidth=x,this.panelHeight=b,this.borderWidth=v,this.pieceSize=E,this.canvasBackgroundColor=P,this.field=this.field.map((e,a)=>[...e].map((e,t)=>new h(T,e,k+x*(t+1),_+b*(a+1),x,b,t,a,v))),this.xLen=this.field[0].length,this.yLen=this.field.length,d.forEach(({gameName:e,pieceSet:a},t)=>{if(e)try{this.putStartPieces(t,e,a)}catch(s){console.error(s)}}),this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=k+this.width,this.bottom=_+this.height,this.stand=new y(this),e.width=c??(m?this.stand.right:this.right)+5,e.height=B??this.bottom+5;let{style:z}=e;"overflow"===$?(""===z.maxWidth&&(z.maxWidth="97vw"),""===z.maxHeight&&(z.maxHeight="92vh")):"horizontal"===$?""===z.width&&(z.width="97vw"):"vertical"===$?""===z.height&&(z.height="92vh"):"parentOverflow"===$?(""===z.maxWidth&&(z.maxWidth="100%"),""===z.maxHeight&&(z.maxHeight="100%")):"parentHorizontal"===$?""===z.width&&(z.width="100%"):"parentVertical"===$&&""===z.height&&(z.height="100%"),this.autoDrawing=L,L&&(j.then(()=>this.draw()),D.then(()=>this.draw()),this.draw()),this.onDrawed=F,this.onGameOver=R,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.moveMode=O,this.record=[],this.turn=0,this.#a=function e(a){let t=!1,s=[],i=null,r=null,{canvas:o}=a,n=(e,t,i=()=>{})=>{let r=window.getComputedStyle(o),n=e.target.getBoundingClientRect(),l=o.width/parseFloat(r.width),d=o.height/parseFloat(r.height);if(e.clientX)l*=e.clientX-n.left,d*=e.clientY-n.top;else if(0<e.touches.length){if(1<e.touches.length)return;l*=e.touches[0].clientX-n.left,d*=e.touches[0].clientY-n.top}else e.preventDefault(),[l,d]=s;a.field.forEach((e,a)=>e.forEach((e,s)=>t(e,l,d,s,a))),i(l,d),a.draw(),s=[l,d]},l=e=>{t=!0,n(e,(t,s,r)=>{let{piece:o,pX:n,pY:l}=t;o&&t.checkRangeMouse(s,r)&&(e.preventDefault(),o.isSelected=!0,i=t,function e(a,t,s,i){let{field:r,yLen:o,enPassant:n}=a;function l(e,a){return r[a]&&r[a][e]&&!r[a][e].hasAttr("keepOut")}function d(e){return e.piece&&t.hasAttr("po")&&e.piece.hasAttr("po")}function S(e,l,S,p="",m=!0){var c;if(!r[S]||!r[S][l])return!1;let g=r[S][l];return!(!g||d(g)||(c=g).piece&&!t.isMoved&&!c.piece.isMoved&&t.hasAttr("pao")&&t.cost<c.piece.cost||"enPassant"===p&&!n.isTarget(g,t)||t.hasAttr("inPalace")&&!g.hasAttr("palace")||0===p.indexOf("palace")&&!(g.hasAttr(p)&&r[i][s].hasAttr(p))||t.hasAttr("unCrossRiver")&&o-(0|o/2)<=a.getRow(l,S,t.deg))&&(e?!!r[S][l].piece&&(!m||t.deg!==r[S][l].piece.deg):!r[S][l].piece)}function p(e,a,t,r,o){for(let n of a)for(let d=0;d<e.length;d++)for(let p=0;p<e[d].length;p++){let[m,c]=[p+s-r,d+i-o];if(!(!l(m,c)||S(t,0|m,0|c,"",!1)||e[d][p]!==n))return!0}return!1}function m(e,a,s){let i=r[s][a];i.addTarget(e),n.setTarget(i,t)}function c(e,[a,{isAttack:t}],{oX:r,oY:o,isOwn:n}){if(n)for(let[d,{child:c=[]}={}]of f)for(let g=0;g<e.length;g++)for(let h=0;h<e[g].length;h++){let[u,B]=[h+s-r,g+i-o];!l(u,B)||!S(t,u,B,a)||e[g][h]!==d||p(e,c,!1,r,o)||m(a,u,B)}}function g(e,[a,{isAttack:t}],{oX:o,oY:n,isOwn:p,offsetX:c,offsetY:g}){if(!(!p&&!S(!1,s+c,i+g)))for(let[h,{jmps:u=0,moves:B=0}={}]of W){let f=!B||0===B;for(let $=n-1;$<=n+1;$++)for(let A=o-1;A<=o+1;A++){if(e[$][A]!==h||A===o&&$===n)continue;let y=u||0,C=B||0,[w,k]=[A-o,$-n];for(let _=s,x=i;;){_+=w,x+=k;let b=_+c,E=x+g;if(!l(b,E)||!f&&0===C)break;let N=0===y;N&&S(t,b,E,a,N)?(C--,m(a,b,E)):u<1&&C--;let X=r[E][b];if(X.piece&&(y--,N||d(X)))break}}}}!function(){let e=t.getRange();for(let a of(e.attack??=e.default,u)){let s=a[0];if(t.isMoved&&["start","castling"].includes(s))continue;let i=e[s];if(i)for(let r of A(i))c(i,a,r),g(i,a,r)}}()}(a,o,n,l))},(t,s)=>{for(let[i,o]of a.stand.stocks)for(let n=o.length-1;0<=n;n--)if(o[n].checkRangeMouse(t,s)){e.preventDefault(),o[n].isSelected=!0,r={deg:i,i:n};return}})},d=e=>{t&&(i||r)&&n(e,(e,a,t)=>{e.isSelected=e.checkRangeMouse(a,t)})},S=e=>{t=!1,n(e,(e,t,s)=>{e.checkRangeMouse(t,s)&&(i&&a.movePiece(i,e),r&&!e.piece&&a.stand.releasePiece(e,r))}),n(e,e=>{e.piece&&(e.piece.isSelected=!1),e.isSelected=!1,e.clearTarget()},()=>{for(let[e,t]of a.stand.stocks)for(let s=t.length-1;0<=s;s--)t[s].isSelected=!1;i=null,r=null})};return o.addEventListener("mousedown",l),o.addEventListener("mousemove",d),o.addEventListener("mouseup",S),o.addEventListener("touchstart",l),o.addEventListener("touchmove",d),o.addEventListener("touchend",S),{removeEvent(){o.removeEventListener("mousedown",l),o.removeEventListener("mousemove",d),o.removeEventListener("mouseup",S),o.removeEventListener("touchstart",l),o.removeEventListener("touchmove",d),o.removeEventListener("touchend",S)}}}(this),M&&(this.#b=this.makePlayerControl(),this.#b.add()),this.enPassant=new class e{constructor(){this.degs={},C.forEach(e=>this.degs[e]=w())}clear(e){this.degs[e]=w()}setTarget(e,a){e.hasTarget("start")&&a.hasAttr("enPassant")&&(this.degs[a.deg].panel=e)}setMoved(e){let{piece:a}=e,t=this.degs[a.deg];a&&e===t.panel?t.piece=a:this.clear(a.deg)}isTarget(e,a){return!e||!e.piece||!!e.piece.hasAttr("enPassant")&&e.piece===this.degs[e.piece.deg].piece}}}makePlayerControl(e){return this.#b=new et(this,e),this.#b}close(){this.#a?.removeEvent(),this.#b?.remove()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#c(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#c(R){let{field:j,xLen:D,yLen:T}=this;if(0===(R=this.degNormal(R)))return;if(![90,180,270].includes(R))throw Error(`deg=${R}, deg need multiple of 90.`);let z=j.map(e=>e.map(({piece:e})=>e));if([90,270].includes(R)){var G;if(D!==T)throw Error(`cols=${D} != rows=${T}, Not rows = cols.`);z=(G=z)[0].map((e,a)=>G.map(e=>e[a]))}[180,270].includes(R)&&z.reverse(),z.forEach(e=>{e.forEach(e=>{e&&(e.deg+=R)}),[90,180].includes(R)&&e.reverse()}),j.forEach((e,a)=>e.forEach((e,t)=>e.piece=z[a][t]))}putStartPieces(e,a,t="default"){let{pieces:i}=this,r=this.degNormal(e);this.#c(r);let o=s[a].position[this.xLen][t];if(!o)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);o.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-o.length;[...e].forEach((e,a)=>{i[e]&&(this.field[t][a].piece=i[e].clone())})}),this.#c(-r),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:o=!1}=i,{pieces:n}=this,l=this.degNormal(s);"string"==typeof e&&(e=new g(this.ctx,n[e],{displayPtn:r,deg:l,isMoved:o})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=k.convTextPieces(e));let o=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(g.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let n=0;n<i;n++)for(let l=0;l<s;l++)try{let d=o[n][l];a[n][l].piece=g.stringToPiece(t,d)}catch{a[n][l].piece=null}this.stand.clear();let S=o[i];S&&S.forEach(e=>{let a=g.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[o,n]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:o<=(l=this.sidePromo?Math.max(...Object.keys(g.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:n<=l}}#d(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver&&this.onGameOver(this,t)))})}#e(I,H,Y,K){let{moveMode:J}=this,{piece:U}=H;if(!U.promo||U.hasAttr("promoted")||U.hasAttr("cantPromotion")||!Y){this.addRecord({fromPanel:I,toPanel:H});return}do for(let[q,{name:V}]of Object.entries(U.promo))if(confirm(`成りますか?
${U.char}:${U.name}
　↓
${q}:${V}`)){U.promotion(q),this.addRecord({fromPanel:I,toPanel:H,end:"成"});return}while("free"!==J&&K);this.addRecord({fromPanel:I,toPanel:H,end:"不成"})}movePiece(e,a){let{stand:t,moveMode:s,enPassant:i}=this;if(!e||"viewOnly"===s||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||"free"!==s&&!a.isTarget)return;let{canPromo:r,forcePromo:o}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,a.piece.isMoved=!0,e.piece=null;let n=this.checkCanPromo(a);r||=n.canPromo,o||=n.forcePromo,i.setMoved(a),this.#e(e,a,r,o),this.#d()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:o={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:o.deg,pieceChar:o.char,end:i,fieldText:this.getTextPieces("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved?1:0))},0<r&&a.splice(this.turn+1)}addRecordComment(e,a=0){this.record[this.turn+a].comment=e}#f(Q){let{record:Z}=this;if(!Z[this.turn+Q])return;this.turn+=Q;let{fieldText:ee,fieldMoved:ea}=Z[this.turn];this.setTextPieces(ee),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=!!ea[a][t])}))}undoRecord(){this.#f(-1)}redoRecord(){this.#f(1)}moveRecord(e){this.turn=e,this.#f(0)}record2String(e,a,t=!1){let{to:s,from:i,deg:r,pieceChar:o,end:n}=e;if(0===a)return"0: 開始局面";let l=({pX:e})=>(this.xLen-e).toString(t?10:36),d=({pY:e})=>(e+1).toString(t?10:36),S=t?",":"";return`${a}: ${g.degChars[r]}${l(s)}${S}${d(s)}${o}${n}${void 0===i.pX?"":` (${l(i)}${S}${d(i)})`}`}getTextRecord(e=!1){return this.record.slice(0,this.turn+1).map((a,t)=>this.record2String(a,t,e)).join(`
`)}getJsonRecord(e=!0){let a=JSON.stringify(this.record,null,"");return e?encodeURI(a):a}setJsonRecord(e,a){this.record=JSON.parse(decodeURI(e)),this.moveRecord(a??this.record.length-1)}draw(){let{ctx:e,canvas:a,left:t,top:s,width:i,height:r,panelWidth:o,panelHeight:n}=this;0===this.turn&&this.addRecord({inc:0}),e.restore(),e.save(),e.clearRect(0,0,a.width,a.height),e.fillStyle=this.canvasBackgroundColor,e.fillRect(0,0,a.width,a.height),e.fillStyle=this.backgroundColor,e.lineWidth=this.borderWidth,e.strokeStyle=this.borderColor,e.save(),e.translate(t,s),e.fillRect(0,0,i,r),e.strokeRect(0,0,i,r),e.translate(o/2,n/2),e.strokeRect(0,0,i-o,r-n),e.restore(),this.stand.draw(),this.field.forEach(e=>{e.forEach(e=>{e.draw()})}),this.onDrawed&&this.onDrawed(this)}getTextPieces(e="default",a=!1){return"bod"===e?k.getTextPieces(this):this.toString("compact"===e,a)}getRecordComment(e=0){return this.record[this.turn+e]??""}toString(e=!1,a=!1){let{xLen:t}=this,s="",i="",r="",o="",n=`
`;return e||(s=`┏${Array(t).fill("━━").join("┯")}┓
`,i=`
┗${Array(t).fill("━━").join("┷")}┛`,r="┃",o="│",n=`
┠${Array(t).fill("──").join("┼")}┨
`),s+this.field.map(t=>r+t.map(t=>t.piece?.toString(a)??t.toString(e)).join(o)+r).join(n)+i+this.stand.toString(e)}async downloadImage(e,a,t){await c(this.canvas,e??this.name??"shogicross",a,t)}}class et{static buttonTexts="<>\uD83D\uDD04\uD83D\uDD01\uD83D\uDCF7";#a(){let{canvas:es}=this.board,ei=window.getComputedStyle(es);this.component.style.maxWidth=parseFloat(ei.width)+"px"}constructor(e,t){this.board=e;let s=new Map([["undoRecord",{title:"一手戻る",text:"&lt;&lt;",onclick:()=>e.undoRecord()}],["redoRecord",{title:"一手進む",text:"&gt;&gt;",onclick:()=>e.redoRecord()}],["rotateLeft",{title:"盤面を左回転",text:"\uD83D\uDD04",onclick:()=>e.rotate(!1)}],["rotateRight",{title:"盤面を右回転",text:"\uD83D\uDD01",onclick:()=>e.rotate()}],["downloadImage",{title:"画像を保存",text:"\uD83D\uDCF7",onclick:()=>e.downloadImage()}]]);t??=[...s.keys(),"textRecord"];let i=Date.now().toString();for(let[r,{onclick:o}]of(this.component=document.createElement("div"),this.component.id=i,this.component.style.display="flex",this.#a(),window.addEventListener("resize",()=>this.#a()),this.component.innerHTML=`${[...s].filter(([e])=>t.includes(e)).map(([e,{title:t,text:s}])=>`<button id="${e}${i}" title="${t}" style="font-family:${a.names};">${s}</button>`).join("")}${t.includes("textRecord")?`<select id="textRecord${i}" style="flex-grow:1; font-family:${a.names};"><option></option></select>`:""}`,s))t.includes(r)&&(this.component.querySelector(`#${r}${i}`).onclick=o);if(!t.includes("textRecord"))return;let n=e.onDrawed??(()=>{});e.onDrawed=async a=>{setTimeout(()=>{let t=this.component.querySelector(`#textRecord${i}`),s=t.querySelector("option"),r=t.cloneNode(!1);a.record.forEach((t,i)=>{let o=s.cloneNode(!1);o.textContent=e.record2String(t,i),i===a.turn&&(o.selected=!0),r.appendChild(o)}),r.onchange=a=>e.moveRecord(a.target.selectedIndex),t.replaceWith(r)}),n(a)}}add(){let{canvas:e}=this.board;e.after(this.component)}remove(){this.component.remove(),window.removeEventListener("resize",()=>this.#a)}}let er=()=>[...new Set([...et.buttonTexts+Object.values(r).map(({displayText:e})=>e).join("")+Object.values(o).map(({display:e})=>e?e.join(""):"").join("")])].sort().join("");return Object.assign(a,{imported:!1,names:"",async importAsync(){if(this.imported)return;let e=er(),t=Date.now().toString();return this.names=a.fonts.map(e=>`"${e[0]}${t}"`).join(",")+",serif",Promise.all(a.fonts.map(async([a,s])=>{let i=a.replace(/ /g,"+"),r=`https://fonts.googleapis.com/css2?family=${i}:wght@${s}&text=${e}`,o=await fetch(r);if(!o.ok)return;let n=(await o.text()).match(/url\(.+?\)/g);if(!n)throw Error("Not found font.");for(let l of n){let d=new FontFace(`${a}${t}`,l);document.fonts.add(d),await d.load().catch(()=>{})}})).then(e=>this.imported=!0)}}),e.Board=F,e.Piece=g,e.boards=i,e.canvasFont=a,e.canvasImage=p,e.extendData=d,e.gameSoft=t,e.games=s,e.panels=r,e.pieceCost=l,e.pieceRange=n,e.pieces=o,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),e}({});