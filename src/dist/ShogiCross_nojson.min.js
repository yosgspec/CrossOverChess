...
`+d}}class Q{#a;#b;static run(e,a){return new Q(e,a)}constructor(e,a){let{name:t,variant:s,url:i,desc:r,playBoard:n,playPieces:o=[],players:l=o.some(({gameName:e},a)=>1<a&&e)?4:2,useStand:d=!1,canvasWidth:S,canvasHeight:p,canvasFit:m="overflow",boardLeft:g=5,boardTop:u=5,panelWidth:h=50,panelHeight:B=0|1.1*h,pieceSize:f=0|.9*h,useRankSize:$=!0,isDrawShadow:y=!0,borderWidth:C=Math.min(h,B)/30,backgroundColor:k="#00000000",autoDrawing:w=!0,moveMode:x="normal",usePlayerControl:N=!0,onDrawed:E,onGameOver:b=(e,a)=>alert(`プレイヤー${a+1}の敗北です。`)}=a;this.name=t,this.variant=s,this.url=i,this.desc=r;let X=O.importAsync(),P=T.importAsync();this.canvas=e;let v=e.getContext("2d");if(v.clearRect(0,0,e.width,e.height),this.ctx=v,this.pieces=A.getPieces(v,{size:f,useRankSize:$,isDrawShadow:y}),!H[n])throw Error(`playBoard=${n}, Unknown board name.`);if(Object.assign(this,H[n]),![2,4].includes(l))throw Error(`players=${l}, players need 2 or 4.`);this.players=l,this.left=g,this.top=u,this.panelWidth=h,this.panelHeight=B,this.borderWidth=C,this.pieceSize=f,this.canvasBackgroundColor=k,this.field=this.field.map((e,a)=>[...e].map((e,t)=>{let s=g+h*(t+1),i=u+B*(a+1);return new oe(v,e,s,i,h,B,t,a,C)})),this.xLen=this.field[0].length,this.yLen=this.field.length,o.forEach(({gameName:e,pieceSet:a},t)=>{if(e)try{this.putStartPieces(t,e,a)}catch(s){console.error(s)}}),this.width=this.panelWidth*(this.xLen+1),this.height=this.panelHeight*(this.yLen+1),this.right=g+this.width,this.bottom=u+this.height,this.stand=new Y(this),e.width=S??(d?this.stand.right:this.right)+5,e.height=p??this.bottom+5;let{style:L}=e;"overflow"===m?(""===L.maxWidth&&(L.maxWidth="97vw"),""===L.maxHeight&&(L.maxHeight="92vh")):"horizontal"===m?""===L.width&&(L.width="97vw"):"vertical"===m?""===L.height&&(L.height="92vh"):"parentOverflow"===m?(""===L.maxWidth&&(L.maxWidth="100%"),""===L.maxHeight&&(L.maxHeight="100%")):"parentHorizontal"===m?""===L.width&&(L.width="100%"):"parentVertical"===m&&""===L.height&&(L.height="100%"),this.autoDrawing=w,w&&(X.then(()=>this.draw()),P.then(()=>this.draw()),this.draw()),this.onDrawed=E,this.onGameOver=b,this.gameAlives=new Map([...Array(this.players).keys()].map(e=>[this.degNormal(e),!0])),this.moveMode=x,this.record=[],this.turn=0,this.#a=me(this),N&&(this.#b=this.makePlayerControl(),this.#b.add()),this.enPassant=new ue}makePlayerControl(e){return this.#b=new _(this,e),this.#b}close(){this.#a?.removeEvent(),this.#b?.remove()}degNormal(e){let a=e;0<a&&a<4&&(a=0|360*a/this.players);do a=(a+360)%360;while(a<0);return a}rotate(e=!0){let a=this.degNormal(1);e||(a=-a),this.#c(a),this.stand.rotate(a),this.autoDrawing&&this.draw()}#c(p){let{field:m,xLen:g,yLen:u}=this;if(0===(p=this.degNormal(p)))return;if(![90,180,270].includes(p))throw Error(`deg=${p}, deg need multiple of 90.`);let h=m.map(e=>e.map(({piece:e})=>e));if([90,270].includes(p)){var B;if(g!==u)throw Error(`cols=${g} != rows=${u}, Not rows = cols.`);h=(B=h)[0].map((e,a)=>B.map(e=>e[a]))}[180,270].includes(p)&&h.reverse(),h.forEach(e=>{e.forEach(e=>{e&&(e.deg+=p)}),[90,180].includes(p)&&e.reverse()}),m.forEach((e,a)=>e.forEach((e,t)=>e.piece=h[a][t]))}putStartPieces(e,a,t="default"){let{pieces:s}=this,i=this.degNormal(e);this.#c(i);let r=U[a].position[this.xLen][t];if(!r)throw Error(`games["${a}"].position["${this.xLen}"]["${t}"]is null.`);r.forEach((e,a)=>{if(e.length<this.xLen)throw Error(e.join(""));let t=a+this.yLen-r.length;[...e].forEach((e,a)=>{s[e]&&(this.field[t][a].piece=s[e].clone())})}),this.#c(-i),this.autoDrawing&&this.draw()}putNewPiece(e,a,t,s,i={}){let{displayPtn:r=0,isMoved:n=!1}=i,{pieces:o}=this,l=this.degNormal(s);"string"==typeof e&&(e=new A(this.ctx,o[e],{displayPtn:r,deg:l,isMoved:n})),this.field[t][a].piece=e,this.autoDrawing&&this.draw()}setTextPieces(e){let{field:a,pieces:t,xLen:s,yLen:i}=this,r="持駒：";0<e.indexOf(r)&&(e=W.convTextPieces(e));let n=[e].concat([..."┏━┯┓┗┷┛┃│┠─┼┨―"],Object.values(A.degChars).map(e=>`
`+e+r)).reduce((e,a)=>e.replace(RegExp(a,"g"),"")).replace(/\n\n/g,`
`).replace(/　/g,"・").trim().split(/\n/).map(e=>e.match(/.{2}/g));for(let o=0;o<i;o++)for(let l=0;l<s;l++)try{let d=n[o][l];a[o][l].piece=A.stringToPiece(t,d)}catch{a[o][l].piece=null}this.stand.clear();let S=n[i];S&&S.forEach(e=>{let a=A.stringToPiece(t,e);a&&this.stand.add(a)}),this.autoDrawing&&this.draw()}getRow(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?r-1-a:90===t?e:180===t?a:270===t?i-1-e:-1}getCol(e,a,t,s=0){let{xLen:i,yLen:r}=this;return 0===(t=this.degNormal(t+s))?e:90===t?r-1-a:180===t?i-1-e:270===t?a:-1}checkCanPromo(e){let{yLen:a}=this,{piece:t,pX:s,pY:i}=e,{deg:r}=t,[n,o]=[t.game.promoLine,t.forcePromoLine].map(e=>a-e-(0|this.promoLineOffset)),l;return{canPromo:n<=(l=this.sidePromo?Math.max(...Object.keys(A.degChars).map(e=>0|e).filter(e=>e!==r).map(e=>this.getRow(s,i,e,180))):this.getRow(s,i,r)),forcePromo:o<=l}}#d(){[...this.gameAlives].forEach(([e,a],t)=>{a&&(this.field.some(a=>a.some(({piece:a})=>a&&a.deg===e&&a.hasAttr("king")))||(this.gameAlives.set(e,!1),this.onGameOver&&this.onGameOver(this,t)))})}#e(f,$,y,C){let{moveMode:k}=this,{piece:w}=$;if(!w.promo||w.hasAttr("promoted")||w.hasAttr("cantPromotion")||!y){this.addRecord({fromPanel:f,toPanel:$});return}do for(let[x,{name:N}]of Object.entries(w.promo))if(confirm(`成りますか?
${w.char}:${w.name}
　↓
${x}:${N}`)){w.promotion(x),this.addRecord({fromPanel:f,toPanel:$,end:"成"});return}while("free"!==k&&C);this.addRecord({fromPanel:f,toPanel:$,end:"不成"})}movePiece(e,a){let{stand:t,moveMode:s,enPassant:i}=this;if(!e||"viewOnly"===s||a.hasAttr("keepOut")||a.piece===e.piece||a.piece?.deg===e.piece.deg||"free"!==s&&!a.isTarget)return;let{canPromo:r,forcePromo:n}=this.checkCanPromo(e);t.capturePiece(e.piece,a.piece,a.hasAttr("capture"),a.hasAttr("cantCapture")),a.piece=e.piece,a.piece.isMoved=!0,e.piece=null;let o=this.checkCanPromo(a);r||=o.canPromo,n||=o.forcePromo,i.setMoved(a),this.#e(e,a,r,n),this.#d()}addRecord(e={}){let{record:a}=this,{fromPanel:t={},toPanel:s={},end:i="",inc:r=1}=e,{piece:n={}}=s;this.turn+=r,a[this.turn]={from:{pX:t.pX,pY:t.pY},to:{pX:s.pX,pY:s.pY},deg:n.deg,pieceChar:n.char,end:i,fieldText:this.getTextPieces("compact",!0),fieldMoved:this.field.map(e=>e.map(({piece:e})=>e?.isMoved?1:0))},0<r&&a.splice(this.turn+1)}addRecordComment(e,a=0){this.record[this.turn+a].comment=e}#f(E){let{record:b}=this;if(!b[this.turn+E])return;this.turn+=E;let{fieldText:X,fieldMoved:P}=b[this.turn];this.setTextPieces(X),this.field.forEach((e,a)=>e.forEach(({piece:e},t)=>{e&&(e.isMoved=!!P[a][t])}))}undoRecord(){this.#f(-1)}redoRecord(){this.#f(1)}moveRecord(e){this.turn=e,this.#f(0)}record2String(e,a,t=!1){let{to:s,from:i,deg:r,pieceChar:n,end:o}=e;if(0===a)return"0: 開始局面";let l=({pX:e})=>(this.xLen-e).toString(t?10:36),d=({pY:e})=>(e+1).toString(t?10:36),S=t?",":"";return`${a}: ${A.degChars[r]}${l(s)}${S}${d(s)}${n}${o}${void 0===i.pX?"":` (${l(i)}${S}${d(i)})`}`}getTextRecord(e=!1){return this.record.slice(0,this.turn+1).map((a,t)=>this.record2String(a,t,e)).join(`
